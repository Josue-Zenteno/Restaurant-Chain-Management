...
public class ManagerEmployee {
		...
		public static void prepareBill() { //Iteration4
			TableWaiter tw = new TableWaiter();
			tw.prepareBill(dishToPrepare);
		}
		
		public static void collectPaymentAndPrepare() { //Iteration4
			TableWaiter tw = new TableWaiter();
			tw.collectPaymentAndPrepare();
		}
